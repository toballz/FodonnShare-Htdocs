                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">No. of Users</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1" id="numusers">loading ...</h1>
                                        </div> 
							...
							<div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">No. of Users Premium</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1" id="numuserspremium">loading ...</h1>
                                        </div> 
                                        <div class="metric-label d-inline-block float-right text-primary font-weight-bold">
                                            <span>N/A</span>
                                        </div>
                            ...
                            <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="text-muted">Estm. Revenue Per Sub.</h5>
                                        <div class="metric-value d-inline-block">
                                            <h1 class="mb-1" id="estimatedrev">loading ...</h1>
                                        </div>
                        ...
                        <div class="row">
                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Type of sub.</th>
                                                        <th class="border-0">No. user</th>
                                                        <th class="border-0">Price</th>
                                                        <th class="border-0">Estm./Sub.</th> 
                                                        <th class="border-0">Quaality</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td>1</td> 
                                                        <td>Active free sub.</td>
                                                        <td id="free">loading ... </td>
                                                        <td>free</td>
                                                        <td>$0</td>
                                                    ...
                                                    <tr>
                                                        <td>2</td> 
                                                        <td>Active weekly sub.</td>
                                                        <td id="weekly">loading ... </td>
                                                        <td>$1.99</td>
                                                        <td id="weeklyestm">loading ...</td>
                                                        <td><span class="badge-dot badge-success mr-1"></span>Delivered </td>
                                                    </tr>
                                                    <tr>
                                                        <td>3</td> 
                                                        <td>Active monthly sub. </td>
                                                        <td id="monthly">loading ... </td>
                                                        <td>$5.99</td>
                                                        <td id="monthlyestm">loading ...</td>
                                                        <td><span class="badge-dot badge-success mr-1"></span>Delivered </td>
                                                    </tr>
                                                    <tr>
                                                        <td>4</td> 
                                                        <td>Active yearly sub.</td>
                                                        <td id="yearly">loading ... </td>
                                                        <td>$69.99</td>
                                                        <td id="yearlyestm">loading ...</td>
                                                        <td><span class="badge-dot badge-success mr-1"></span>Delivered </td>
                                                    </tr>
                                                    <tr>
                                                        <td>5</td> 
                                                        <td>Active onetime sub.</td>
                                                        <td id="onetime">loading ... </td>
                                                        <td>$299.99</td>
                                                        <td id="onetimeestm">loading ...</td>
                                                        <td><span class="badge-dot badge-success mr-1"></span>Delivered </td>
                                                    </tr>
                                                    <tr>
                           ...
                           <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    ...
                                    <div id="sssa" style="height: 315px;"></div> 
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body p-0">
                                        <ul class="social-sales list-group list-group-flush">
                                            <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle facebook-bgcolor mr-2"><i class="fab fa-facebook-f"></i></span><span class="social-sales-name">Facebook</span><span class="social-sales-count text-dark" id="trafficfromfacebook">Loading ...</span></li>
                                            <li class="list-group-item social-sales-content"><span class="social-sales-icon-circle twitter-bgcolor mr-2"><i class="fab fa-twitter"></i></span><span class="social-sales-name">Twitter</span><span class="social-sales-count text-dark" id="trafficfromtwitter">Loading ...</span></li>
	...
	function subGraph(aff){ 
        if ($('#sssa').length) {
            Morris.Donut({
                ...
                labelColor: '#2e2f39',
                   gridTextSize: '14px',
                colors: ["#5969ff","#ff407b","#25d5f2","#ffc750","#66a32f"],
		...
		var apiconn=(true)?"../dminapi.php":"http://fodonn.com/.admin/a/dminapi.php";
		$.get(apiconn+"?api=235",function(datas){ 

			$("#numusers").html( parseInt(datas['numusers']).toLocaleString('en-US', { style: 'decimal' })+" users" );
			$("#numuserspremium").html( parseInt(datas['numuserspremium']).toLocaleString('en-US', { style: 'decimal' })+" users"  );
			
			$("#free").html( datas['activefreesub']+" users"  );
			$("#weekly").html( datas['activeweekelysub']+" users"  );
			$("#monthly").html( datas['activemonthlysub']+" users"  );
			$("#yearly").html( datas['activeyearlysub']+" users"  );
			$("#onetime").html( datas['activeonetimesub']+" users"  );
			
			
			if(1==1){
				var weeklyRev=(parseInt(datas['activeweekelysub'])*1.99),
				monthlyRev=(parseInt(datas['activemonthlysub'])*5.99),
				yearlyRev=(parseInt(datas['activeyearlysub'])*69.99),
				onetimeRev=(parseInt(datas['activeonetimesub'])*299.99);
				
				var estimatedRev=weeklyRev+monthlyRev+yearlyRev+onetimeRev;
				$("#estimatedrev").html( "$ "+estimatedRev.toLocaleString('en-US', { style: 'decimal' }) );
				
				
				$("#weeklyestm").html("$ "+weeklyRev.toLocaleString('en-US', { style: 'decimal' }));
				$("#monthlyestm").html("$ "+monthlyRev.toLocaleString('en-US', { style: 'decimal' }));
				$("#yearlyestm").html("$ "+yearlyRev.toLocaleString('en-US', { style: 'decimal' }));
				$("#onetimeestm").html("$ "+onetimeRev.toLocaleString('en-US', { style: 'decimal' }));
				
				subGraph(
				[
                    { value: datas['activefreesub'], label: 'Free' },
                    { value: datas['activeweekelysub'], label: 'Weekly' },
                    { value: datas['activemonthlysub'], label: 'Monthly' },
                    { value: datas['activeyearlysub'], label: 'Yearly' },
                    { value: datas['activeonetimesub'], label: 'Onetime' }
                ]
